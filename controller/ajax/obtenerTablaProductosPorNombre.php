<?php
    ...
    $nombreTipo=analizadorFormulario($_GET['nombreTipo']);
    $conexionDB=ConexionDB::conectar();

    $consultaIdTipo=$conexionDB->query("SELECT idTipo FROM tipos WHERE nombreTipo='$nombreTipo'");
    $arrayTipo=$consultaIdTipo->fetch(PDO::FETCH_ASSOC);
            ...
            echo "<div class='contenedorFilaProducto'>";
                ...
                echo "<a class='contenido' style='background-color: #75d169;' href='./tablaProductoUnitarioController.php?idProducto={$valor['idProducto']}'>";
                    ...
                    echo "<div class='contenedorBotonesTablaProductos'>" ;
                        ...
                        // CORREGIDO: Eliminada la llave '}' al final de la variable $idTipo
